...
namespace AutoLotDAL_Core2.EF
{
    public class AutoLotContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                var connectionString = @"server=NOTEBOOK\MSSQLSERVER2014;database=AutoLotCore2_Prod;integrated security=True; MultipleActiveResultSets=True;App=EntityFramework;";

                //throw an exception when mixed-mode evaluation occurs.
