...
3.1 Using the EF .NET CLI Commands
	...
	To add the migration to create your database, make sure to save all of the files, build the project (for safe measure), and then execute the following:
		...
		dotnet ef migrations add Staging --context AutoLotDAL_Core2.EF.AutoLotContext -o EF\Migrations
		dotnet ef migrations add Product --context AutoLotDAL_Core2.EF.AutoLotContext -o EF\Migrations
